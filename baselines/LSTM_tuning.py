...
def process_test(df, model,nn,cc,data_no_scale,backup2,test_2,data_no_scale_2,a_user,backup):
    ...
    for i in x:
        ...
        if (out == np.argmax(yhat)):
            ...
            yes = is_in_topk(act[len-1][10],score,20)
            if (yes == 1):
                in_five += 1
            print("is it in top 5? ",yes)
            
            if (yes == 0):
                dx,xxx = min_dist_find(act[len-1][10],score,20)
    ...
    print("total in top twenty ",in_five)
    print("percentage in top twenty ",(in_five/total) * 100.00)
...
embed_91=Dense(10-3,input_dim=maxlen-1)(input_91)
...
embed_10=Dense(4+5-3,input_dim=maxlen-1)(input_10)
...
embed_11=Dense(4+5-3,input_dim=maxlen-1)(input_11)
...
embed_12=Dense(8-3,input_dim=maxlen)(input_12)
...
embed_13=Dense(8-3,input_dim=maxlen-1)(input_13)
...
embed_14=Dense(10-3,input_dim=maxlen-1)(input_14)
...
embed_18=Dense(10-3,input_dim=maxlen)(input_18)
...
z = LSTM(1000,return_sequences=False,dropout=0.15,recurrent_dropout=0.15)(z) ##1200,0.15,0.15
#z = LSTM(300,return_sequences=False,dropout=0.15,recurrent_dropout=0.15)(z)
#z = Dropout(0.20)(z)
#z = Attention()(z)
z = Dense(nn,activation='softmax')(z)
...
print(model.summary())
SGD = tf.keras.optimizers.SGD(learning_rate=0.0001, momentum=0.5)
...
print("test LSTM (for all user) for usa top 20")
