...
def process_test(df, model,nn,cc,data_no_scale,backup2,test_2,data_no_scale_2,a_user,backup):
    ...
    for i in x:
        ...
        if (out == np.argmax(yhat)):
            ...
            yes = is_in_topk(act[len-1][10],score,1)
            if (yes == 1):
                in_five += 1
            print("is it in top 5? ",yes)
            
            if (yes == 0):
                dx,xxx = min_dist_find(act[len-1][10],score,1)
    ...
    print("total in top one ",in_five)
    print("percentage in top one ",(in_five/total) * 100.00)
...
embed_91=Dense(7,input_dim=maxlen-1)(input_91)
...
embed_10=Dense(6,input_dim=maxlen-1)(input_10)
...
embed_11=Dense(6,input_dim=maxlen-1)(input_11)
...
embed_12=Dense(5,input_dim=maxlen)(input_12)
...
embed_13=Dense(5,input_dim=maxlen-1)(input_13)
...
embed_14=Dense(7,input_dim=maxlen-1)(input_14)
...
embed_18=Dense(7,input_dim=maxlen)(input_18)
...
'''
z = Conv1D(500, 2, activation = 'relu')(z)
z = Dropout(0.15)(z)
z = Conv1D(500, 1, activation = 'relu')(z)
'''
#z = Dense(200, activation='relu')(z)
#z = Dropout(0.15)(z)
#z = Dense(100, activation='relu')(z)
z = Bidirectional(LSTM(1000,return_sequences=False,dropout=0.15,recurrent_dropout=0.15))(z) ##1200,0.15,0.15
...
print("test bidirectional LSTM USA, all user, top 1 ")
